...
class Seasar_Zf_Controller_S2ActionHelper extends Zend_Controller_Action_Helper_Abstract {
    ...
    public function preDispatch() {
        ...
        $dicons = array("$moduleDir/dicons/dicon.php",
                        "$moduleDir/dicons/$controller.php",
                        "$moduleDir/dicons/$controller/dicon.php",
                        "$moduleDir/dicons/$controller/$action.php");
        foreach($dicons as $dicon) {
            if (file_exists($dicon)) {
