 ...
 */
/**
 * @file S2Container_AbstractAssemblerTest.php
 * @author 
 * @version $Id$
 */
...
/**
 * @package org.seasar.framework.container.assembler
 * @class S2Container_AbstractAssemblerTest
 */
class AbstractAssemblerTests extends PHPUnit2_Framework_TestCase {
     ...
     * @return 
     */
    public function testGetBeanDesc() {

        $asm = new TestAbstractAssembler (new S2Container_ComponentDefImpl('A'));       
        $this->assertType('TestAbstractAssembler', $asm);
    ...
    /**
     * testGetComponentClass
     * @return 
     */
    public function testGetComponentClass(){
