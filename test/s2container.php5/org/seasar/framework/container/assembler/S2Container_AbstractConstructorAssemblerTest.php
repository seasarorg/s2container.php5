 ...
 */
/**
 * @file S2Container_AbstractConstructorAssemblerTest.php
 * @author 
 * @version $Id$
 */
...
/**
 * @package org.seasar.framework.container.assembler
 * @class S2Container_AbstractConstructorAssemblerTest
 */
class AbstractConstructorAssemblerTests extends PHPUnit2_Framework_TestCase {
     ...
     * @return 
     */
    public function testAssembleDefault() {

        $asm = new TestAbstractConstructorAssembler(new S2Container_ComponentDefImpl('A'));       
        $this->assertType('TestAbstractConstructorAssembler', $asm);
