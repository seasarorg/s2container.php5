 ...
 */
/**
 * @file S2Container_AopProxyUtilTest.php
 * @author 
 * @version $Id$
 */
 ...
 */
class AopProxyUtilTests extends PHPUnit2_Framework_TestCase {
     ...
     * @return 
     */
    public function testGetProxyObject() {
        ...
        $this->assertType('AEnhancedByS2AOP', $a);
    } 
}
?>