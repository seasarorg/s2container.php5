...
class S2Container_YamlS2ContainerBuilderTest
    ...
    public function __construct($name) {
        ...
        if (!defined('DICON_DIR_S2Container_YamlS2ContainerBuilderTest')){
            define('DICON_DIR_S2Container_YamlS2ContainerBuilderTest',
                    $this->diconDir);
    ...
    function testDicon() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testDicon.dicon.yml');
        $this->assertType('S2Container', $container);
       
        $a = $container->getComponent('a');
        $this->assertType('A_S2Container_YamlS2ContainerBuilder',$a);

        $b = $container->getComponent('testDicon.b');
        $this->assertType('A_S2Container_YamlS2ContainerBuilder',$b);
    }

    function testComp() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testComp.yml');
    ...
    function testArgValue() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testArgValue.yml');
        $this->assertNotNull($container);
    ...
    function testArgComp() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testArgComp.yml');
        $this->assertNotNull($container);
       
        $n = $container->getComponent('n');
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$n->getVal1());

        $m = $container->getComponent('m');
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$m->getVal1());

        $o = $container->getComponent('o');
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$o->getVal1());
    }
    
    function testArgs() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testArgs.yml');
        $this->assertNotNull($container);
        ...
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$r->getVal1());
        $this->assertEquals($r->getVal2(),'val 2');
    ...
    function testInitMethod() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testInitMethod.yml');
        $this->assertNotNull($container);
    ...
    function testDestroyMethod() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testDestroyMethod.yml');
        $this->assertNotNull($container);
        $container->init();
    ...
    function testMeta() {
        ...
        $this->assertType('N_S2Container_YamlS2ContainerBuilder',$m->getValue());
    ...
    function testInclude() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testIncludeA.yml');
        $this->assertNotNull($container);
        $a = $container->getComponent("a");
        $n = $container->getComponent("testIncludeB.n");
        $this->assertType('A_S2Container_YamlS2ContainerBuilder',$a);
        $this->assertType('N_S2Container_YamlS2ContainerBuilder',$n);
    }
    
    function testCalc() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testCalc.yml');
    ...
    function testCalcAuto() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testCalcAuto.yml');
    ...
    function testPrototype() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testPrototype.yml');
        $a = $container->getComponent("AddActionImpl_S2Container_YamlS2ContainerBuilder");
        $b = $container->getComponent("AddActionImpl_S2Container_YamlS2ContainerBuilder");
    ...
    function testAop() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testAop.yml');
        $a = $container->getComponent("AddActionImpl_S2Container_YamlS2ContainerBuilder");
        $this->assertEquals($a->add(5,3),8);
        $s = $container->getComponent("SubActionImpl_S2Container_YamlS2ContainerBuilder");
        $this->assertEquals($s->sub(5,3),2);
    }

    function testBinding() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testBinding.dicon.yml');
        $o = $container->getComponent("O_S2Container_YamlS2ContainerBuilder");
        $g = $container->getComponent("G_S2Container_YamlS2ContainerBuilder");
    ...
    function testRequest() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testRequest.dicon.yml');
        $l = $container->getComponent("l");
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$l->getComp());
        ...
        $l = $container->getComponent('l');
        $this->assertType('L_S2Container_YamlS2ContainerBuilder',$l);
    }
    ...
    function testSession() {
        ...
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$ll->getComp());
    ...
    function testUuSet() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testUuSet.dicon.yml');
        $m = $container->getComponent("m");
    ...
    function testSameName() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testSameName.dicon.yml');
        $this->assertNotNull($container);
    ...
    function testContainerInject() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testContainerInject.dicon.yml');
        $this->assertNotNull($container);
       
        $v = $container->getComponent('V_S2Container_YamlS2ContainerBuilder');
        $con = $v->getContainer();
    ...
    function testPintcutEreg() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testPintcutEreg.dicon.yml');
    ...
    function testArgMeta() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testArgMeta.dicon.yml');
    ...
    function testPropertyMeta() {
        $container = S2ContainerFactory::create(
                                $this->diconDir . '/testPropertyMeta.dicon.yml');              
    ...
    function testChildComponent() {
        ...
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$d);

        $n2 = $container->getComponent('n2');
        $this->assertType('N_S2Container_YamlS2ContainerBuilder',$n2);
        
        $d2 = $n2->getVal1();
        
        $this->assertType('D_S2Container_YamlS2ContainerBuilder',$d2);
    ...
    function testSingletonS2ContainerDestroy() {
        ...
        $container = S2Container_SingletonS2ContainerFactory::getContainer(
                       $this->diconDir . '/testSingletonS2ContainerDestroy.yml');
    ...
    function testCircularIncludeRuntimeException() {
        try{ 
            $container = S2ContainerFactory::create(
                             $this->diconDir . '/testCircularIncludeRuntimeExceptionA.dicon.yml');
        }catch(Exception $e){
...
class A_S2Container_YamlS2ContainerBuilder
    implements IA_S2Container_YamlS2ContainerBuilder{
    public function __construct(){}
} 

interface IB_S2Container_YamlS2ContainerBuilder{}
class B_S2Container_YamlS2ContainerBuilder
    extends A_S2Container_YamlS2ContainerBuilder
    implements IB_S2Container_YamlS2ContainerBuilder{
    function __construct() {
        parent::__construct();
    }
}

class C_S2Container_YamlS2ContainerBuilder {
    private $name;
...
interface IG_S2Container_YamlS2ContainerBuilder{}
class D_S2Container_YamlS2ContainerBuilder implements IG_S2Container_YamlS2ContainerBuilder{}

class G_S2Container_YamlS2ContainerBuilder 
    implements IG_S2Container_YamlS2ContainerBuilder {
...
class I_S2Container_YamlS2ContainerBuilder {
    ...
    function culc3(IG_S2Container_YamlS2ContainerBuilder $d){
        if($d instanceof D){
            $this->result = 4;
        }else{return -1;}
    }
...
class L_S2Container_YamlS2ContainerBuilder {
    private $comp;

    function setComp(IG_S2Container_YamlS2ContainerBuilder $comp){
        $this->comp = $comp;
    }
...
class M_S2Container_YamlS2ContainerBuilder {
    private $name;
...
class N_S2Container_YamlS2ContainerBuilder {
...
interface IO_S2Container_YamlS2ContainerBuilder {
    function om1();
    function om2();
}
class O_S2Container_YamlS2ContainerBuilder
    implements IO_S2Container_YamlS2ContainerBuilder {
    function om1() {
    }
...
class R_S2Container_YamlS2ContainerBuilder {
...
class S_S2Container_YamlS2ContainerBuilder {
    private $val1;
    private $val2;
    private $refO;
    private $refG;
    
    function __construct($val1="",IO_S2Container_YamlS2ContainerBuilder $o) {
        $this->val1 = $val1;
        $this->refO = $o;
    }
    ...
    function setRefG(IG_S2Container_YamlS2ContainerBuilder $g){
        $this->refG = $g;
    }    
    function getRefG(){
        return $this->refG;
...
class V_S2Container_YamlS2ContainerBuilder {
...
interface IDelegateA_S2Container_YamlS2ContainerBuilder {
    function ma();
    function mc();    
}
class DelegateA_S2Container_YamlS2ContainerBuilder
    implements IDelegateA_S2Container_YamlS2ContainerBuilder {
...
class Date_S2Container_YamlS2ContainerBuilder {
    function getTime(){
        return '12:00:30';
    }
...
interface ICalculator_S2Container_YamlS2ContainerBuilder {
   public function add($a,$b);
   public function sub($a,$b);
   public function div($a,$b);
}
class CalculatorImpl_S2Container_YamlS2ContainerBuilder
    implements ICalculator_S2Container_YamlS2ContainerBuilder {
   public function add($a,$b) {
       return $a+$b;
   }
   public function sub($a,$b) {
...
interface IAddAction_S2Container_YamlS2ContainerBuilder {
   public function add($a,$b);
}
class AddActionImpl_S2Container_YamlS2ContainerBuilder
    implements IAddAction_S2Container_YamlS2ContainerBuilder {
   
   private $logic;
   
   public function __construct(ICalculator_S2Container_YamlS2ContainerBuilder $logic) {
       $this->logic = $logic;
   }
...
interface ISubAction_S2Container_YamlS2ContainerBuilder {
   public function sub($a,$b);
}

class SubActionImpl_S2Container_YamlS2ContainerBuilder
    implements ISubAction_S2Container_YamlS2ContainerBuilder {
   
   private $logic;
   
   public function setLogic(ICalculator_S2Container_YamlS2ContainerBuilder $logic) {
       $this->logic = $logic;
   }
...
class A_InterType_S2Container_YamlS2ContainerBuilder {
    public $aaa;
    protected $bbb;
    private $ccc;
