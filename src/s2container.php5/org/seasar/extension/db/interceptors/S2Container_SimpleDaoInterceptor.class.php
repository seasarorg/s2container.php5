 ...
 * @author klove
 */
class S2Container_SimpleDaoInterceptor extends S2Container_AbstractInterceptor {

	private $daoMetaDataFactory_;

	public function S2Container_SimpleDaoInterceptor(S2Container_DaoMetaDataFactory $daoMetaDataFactory) {
	...
	public function invoke(S2Container_MethodInvocation $invocation) {
		...
		$daoInterface = S2Container_DaoMetaDataImpl::getDaoInterface($targetClass);
