 ...
 * @author klove
 */
class S2Container_DaoNotFoundRuntimeException extends S2Container_S2RuntimeException {
	
	private $targetClass_;
	
	public function S2Container_DaoNotFoundRuntimeException($targetClass) {
