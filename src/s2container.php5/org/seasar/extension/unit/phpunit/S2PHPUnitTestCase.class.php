...
// +----------------------------------------------------------------------+
//
// $Id: S2PHPUnitTestCase.class.php,v 1.1 2005/08/02 14:00:03 klove Exp $
/**
 * @package org.seasar.extension.unit.phpunit
 * @author klove
 */
class S2PHPUnitTestCase extends PHPUnit_TestCase {
	...
	private function isAutoBindable(ReflectionProperty $field) {
		return !$field->isStatic() and $field->isPublic() and
		        !preg_match("/^PHPUnit_/",$field->getDeclaringClass()->getName());
	}
