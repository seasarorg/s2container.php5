...
// +----------------------------------------------------------------------+
//
// $Id: RequestComponentDeployer.class.php,v 1.1 2005/05/28 16:50:12 klove Exp $
/**
 * @package org.seasar.framework.container.deployer
 * @author klove
 */
class RequestComponentDeployer extends AbstractComponentDeployer {
     ...
     * @param ComponentDef
     */
    public function RequestComponentDeployer(ComponentDef $componentDef) {
